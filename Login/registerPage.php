              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="col-12">
                      ...
                      <input type="text" name="name" class="form-control" id="yourName" value="<?php if(isset($name))echo htmlspecialchars($name);?>" required>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" name="username" class="form-control" id="yourUsername" value="<?php if(isset($username)) echo $username;?>" required>
                    ...
                    <div class="col-12">
                      ...
                      <input type="email" name="email" class="form-control" id="yourEmail" value="<?php if(isset($email)) echo $email;?>" required>
