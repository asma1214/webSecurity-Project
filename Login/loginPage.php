...
<nav id="navbar" class="navbar nav-menu">
  <ul>
    <li><a href="../Home/index.php" class="nav-link scrollto active"><i class="bx bx-home"></i> <span>Home</span></a></li>
    <li><a href="../Home/index.php#about" class="nav-link scrollto"><i class="bx bx-question-mark"></i> <span>About</span></a></li>
    <li><a href="<?php $_SERVER['PHP_SELF'] ?>" class="nav-link scrollto"><i class="bx bxl-bitcoin"></i> <span>Miners</span></a></li>
    <li><a href="../Home/index.php#services" class="nav-link scrollto"><i class="bx bx-server"></i> <span>Services</span></a></li>
    <li><a href="../Home/index.php#contact" class="nav-link scrollto"><i class="bx bx-envelope"></i> <span>Contact</span></a></li>
  </ul>
</nav> 
<!-- .nav-menu  -->
              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <form action="<?php $_SERVER['PHP_SELF'] ?>" method = 'POST' class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Don't have account? <a href="registerPage.php">Create an account</a></p>
                    </div>
                  </form>
