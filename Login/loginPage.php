...
<nav id="navbar" class="navbar nav-menu">
  <ul>
    ...
    <li><a href="../Home/home.php#about" class="nav-link scrollto"><i class="bx bx-question-mark"></i> <span>About</span></a></li>
    <li><a href="<?php $_SERVER['PHP_SELF'] ?>" class="nav-link scrollto"><i class="bx bxl-bitcoin"></i> <span>Miners</span></a></li>
    <li><a href="../Home/home.php#services" class="nav-link scrollto"><i class="bx bx-server"></i> <span>Services</span></a></li>
    <li><a href="../Home/home.php#contact" class="nav-link scrollto"><i class="bx bx-envelope"></i> <span>Contact</span></a></li>
  </ul>
</nav> 
<!-- .nav-menu  -->
